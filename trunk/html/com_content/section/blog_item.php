...
<p class="buttonheading">
	<?php if ($this->item->params->get('show_pdf_icon')) :
		echo GetArtIcon::pdf($this->item, $this->item->params, $this->access);
	endif;
	if ($this->item->params->get('show_print_icon')) :
		echo GetArtIcon::print_popup($this->item, $this->item->params, $this->access);
	endif;
	if ($this->item->params->get('show_email_icon')) :
		echo GetArtIcon::email($this->item, $this->item->params, $this->access);
	endif; ?>
</p>
<?php endif; ?>
