...
class Wright
{
	...
	{                                           
		...
		if (is_file(JPATH_THEMES . DS . $this->document->template . DS . 'css' . DS . 'style-' . $this->document->params->get('style') . '.css'))
         ...
         if (is_file(JPATH_THEMES . DS . $this->document->template . DS . 'css' . DS . 'superfish-' . $this->document->params->get('style') . '.css'))
			$styles['template'][] = 'superfish-' . $this->document->params->get('style') . '.css';
